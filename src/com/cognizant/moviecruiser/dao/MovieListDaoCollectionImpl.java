...
public class MovieListDaoCollectionImpl  implements MovieListDao{
	...
	public MovieListDaoCollectionImpl()
	{
		if(movieList == null)
		{
			...
			movieList.add(new MovieList(0000002,"The Avengers",1518812988,true,
					DateUtil.convertToDate("23/12/2017"),"Superhero",false));
			movieList.add(new MovieList(0000003,"Titanic",218746394,true,
					DateUtil.convertToDate("21/08/2012"),"Romance",false));
			movieList.add(new MovieList(0000004,"Jurassic World",1671713208,false,
					DateUtil.convertToDate("02/07/2017"),"Science Fiction",true));
			movieList.add(new MovieList(0000005,"Avengers:End Game",275076034,true,
					DateUtil.convertToDate("12/07/2022"),"Superhero",true));
	...
	{
		if(movieList1.getDate().getTime() <=today.getTime() && movieList1.isActive() ){
	...
	/* (non-Javadoc)
	 * @see com.cognizant.moviecruiser.dao.MovieListDao#modifyMenuItem(com.cognizant.moviecruiser.model.MovieList)
	 */
	@Override
